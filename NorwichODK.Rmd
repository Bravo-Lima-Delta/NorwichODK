...
#### Candidacy Eligibility for Graduate Students

* **You must be a Current Student in the MSL Major or an MBA Major with Organizational Leadership Concentration or an alumni of one of those two programs from Norwich University.** If you are a current student, you must have completed four seminars of graduate-level work in the MSL program or an MBA major with an Organizational Leadership concentration.
* **You must achieve and maintain GPA of: 3.70.**  If you are a current student, you can find your GPA in your Virtual Campus.  Follow Instructions below in 'Accessing Virtual Campus' section.
* **Complete Norwich University's $\small O \Delta K$ Circle Application Form**, including:

    + An essay describing your demonstrated Professional Leadership results in each of Norwich University’s 4 Values-Based Leadership Dimensions. First-Person, APA 6th Edition format with Cover Page and Reference Page. Not To Exceed 1500 words. Be sure to cover all 4 dimensions:
...
#### Candidacy Eligibility for Undergraduate Students
...
**Application are received on a rolling basis.  Notifications of acceptance are issued quarterly.**

**Current Students:** Please follow this [link](https://dynamicforms.ngwebsolutions.com/Submit/Page?form=82cc3f59-cc19-4835-89e0-27b3cb319f56&page=340173&token=iKbtR-5qHU2CW-giBYSwj42jsa-zBofqRCbahlBcpjw) to fill out the application.  This will set up all email notifications to go to your Norwich University email account.

**Graduates/Alumni:** Please follow this [link](https://dynamicforms.ngwebsolutions.com/Submit/Page?form=82cc3f59-cc19-4835-89e0-27b3cb319f56&page=340173&token=iKbtR-5qHU2CW-giBYSwj42jsa-zBofqRCbahlBcpjw) to fill out the application.  You will need to set up a Dynamic Forms account and identify an email address for the notifications to go to.
...
#### Instructions for Accessing Virtual Campus

* Log in to your Virtual Campus http://online.norwich.edu/current-students
* Select NU Pay in the center red tab.
* A new blue and white page should open in another window.
* Select Student Services, then Student Records, then Academic Transcript.
