...
theme_3 <-
  theme(
    ...
    axis.title.x = element_text(size = 24, family = "Palatino", color=odk_colors[5]),
    axis.title.y = element_blank(),
    plot.title = element_text(family = "Palatino", size = 30, color=odk_colors[5]),
...
#Table to plot inductees through time
  ...
  labs(title = "Count of Norwich Circle Inductees", color = odk_colors[5]) +
  xlab("Year") +
  ylab("") +
  theme_classic() +
  theme_3
